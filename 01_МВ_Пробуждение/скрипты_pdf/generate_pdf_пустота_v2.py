...
Читает текст из КНИГА_ПУСТОТА_v2.md и верстает PDF
...
def build_pdf(text_file, output_path):
    ...
    # ── ОБЛОЖКА ──
    cover_path = "/tmp/mvs_cover_пустота_v2.pdf"
    ...
    # ── КОНТЕНТ ──
    content_path = "/tmp/mvs_content_пустота_v2.pdf"
...
if __name__ == "__main__":
    TEXT_FILE = "/home/user/workspace/КНИГА_ПУСТОТА_v2.md"
    OUTPUT = "/home/user/workspace/МВ_Пробуждение_ПУСТОТА_v2.pdf"
