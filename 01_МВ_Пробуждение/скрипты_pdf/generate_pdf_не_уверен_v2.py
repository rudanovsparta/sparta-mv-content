...
Читает текст из КНИГА_НЕ_УВЕРЕН_v2.md и верстает PDF
...
def build_pdf(text_file, output_path):
    ...
    # ── ОБЛОЖКА ──
    cover_path = "/tmp/mvs_cover_не_уверен_v2.pdf"
    ...
    # ── КОНТЕНТ ──
    content_path = "/tmp/mvs_content_не_уверен_v2.pdf"
...
if __name__ == "__main__":
    TEXT_FILE = "/home/user/workspace/КНИГА_НЕ_УВЕРЕН_v2.md"
    OUTPUT = "/home/user/workspace/МВ_Пробуждение_НЕ_УВЕРЕН_v2.pdf"
