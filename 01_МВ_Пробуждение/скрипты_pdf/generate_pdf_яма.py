...
Читает текст из КНИГА_ЯМА_текст.md и верстает PDF
...
def build_pdf(text_file, output_path):
    ...
    # ── ОБЛОЖКА ──
    cover_path = "/tmp/mvs_cover_yama.pdf"
    ...
    # ── КОНТЕНТ ──
    content_path = "/tmp/mvs_content_yama.pdf"
...
if __name__ == "__main__":
    TEXT_FILE = "/home/user/workspace/КНИГА_ЯМА_текст.md"
    OUTPUT = "/home/user/workspace/МВ_Пробуждение_ЯМА.pdf"
