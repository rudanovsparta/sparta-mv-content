...
Читает текст из КНИГА_СТЕНА_v3.md и верстает PDF
...
def build_pdf(text_file, output_path):
    ...
    # ── ОБЛОЖКА ──
    cover_path = "/tmp/mvs_cover_стена_v3.pdf"
    ...
    # ── КОНТЕНТ ──
    content_path = "/tmp/mvs_content_стена_v3.pdf"
...
if __name__ == "__main__":
    TEXT_FILE = "/home/user/workspace/КНИГА_СТЕНА_v3.md"
    OUTPUT = "/home/user/workspace/МВ_Пробуждение_СТЕНА_v3.pdf"
